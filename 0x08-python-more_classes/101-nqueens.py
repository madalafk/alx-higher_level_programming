...
Determines all possible solutions to placing the queen(N)
...
Solutions takes the format [[r, c], [r, c], [r, c], [r, c]]
where 'r' is the row and 'c' is the column where the queen is placed on the board
"""
import sys
